        ...
        <motion.div className="max-w-[1500px] mx-auto px-3 sm:px-4 lg:px-8 ">
          <div className="h-[52px] md:h-[78px] flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3 md:gap-4 shrink-0">
              ...
              <Link to="/addtocart"
                className="lg:flex relative w-8 h-8 md:w-[48px] md:h-[48px] rounded-full bg-purple-600 text-white flex items-center justify-center shadow-lg hover:scale-105 transition">
