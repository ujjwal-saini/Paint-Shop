        ...
        <div className="max-w-[1500px] mx-auto px-4 lg:px-8 py-3">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 flex-1">
              ...
              <Link to="/"> <img src={logo2} alt="logo" className="h-12 object-contain" /></Link>

              <div className="hidden md:flex relative flex-1 max-w-[600px]">
                <Search size={20} className="absolute top-1/2 left-4 -translate-y-1/2 text-gray-400" />
        ...
        <div className="hidden md:block border-t bg-white">
          <div className="max-w-[1000px] mx-auto flex items-center gap-8 px-6 py-4">
            ...
            <div className="relative group">
              <Link to={'/products'} className="flex items-center gap-1 text-sm font-medium hover:text-purple-600 transition">
                Products
                <ChevronDown size={16} />
              </Link>
